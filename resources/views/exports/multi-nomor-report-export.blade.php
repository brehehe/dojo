<table>
    <thead>
        <tr>
            <th colspan="6" style="font-weight: bold; text-align: center; font-size: 14pt;">LAPORAN DAFTAR SEMUA ATLET &amp; NOMOR PERTANDINGAN</th>
        </tr>
        <tr>
            <th colspan="6"></th>
        </tr>
        <tr>
            <th colspan="6" style="font-weight: bold; font-size: 12pt; background-color: #dbeafe; border: 1px solid #000;">DAFTAR ATLET</th>
        </tr>
        <tr style="background-color: #f1f5f9; border: 1px solid #000;">
            ...
            <th style="font-weight: bold; border: 1px solid #000;">KONTINGEN</th>
            <th style="font-weight: bold; border: 1px solid #000; text-align: center;">JUMLAH NOMOR</th>
            <th style="font-weight: bold; border: 1px solid #000;">DAFTAR NOMOR (TIPE)</th>
    ...
    <tbody>
        ...
        @forelse($allAthletes as $a)
            ...
            <tr>
                ...
                <td style="border: 1px solid #000;">{{ $a['contingent'] }}</td>
        ...
        @empty
            <tr>
                <td colspan="6" style="border: 1px solid #000; text-align: center; italic: true;">Tidak ada atlet.</td>
            </tr>
        @endforelse
    </tbody>
</table>
