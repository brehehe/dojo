<div>
    @push('styles')
        <style>
            ...
            .ctg-reg-pill.pending {
                background: rgba(245, 158, 11, .1);
                color: #d97706;
            }

            .ctg-reg-pill.verified {
                background: rgba(39, 174, 96, .1);
                color: #27ae60;
            }

            .ctg-reg-pill.rejected {
    ...
    <div class="sch-hero">
        <div class="sch-hero-label">Kontingen Terdaftar</div>
        <h2 class="sch-hero-title">{{ $contingent->name }}</h2>
        <p class="sch-hero-sub">{{ $contingent->kab_kota }}</p>
        <a href="/piala_walikotasby2026" class="ctg-hero-cta" style="margin-top: 10px;">
                ...
                <div class="ctg-reg-body">
                    ...
                    @if (in_array($reg->status, ['draft', 'pending']))
                        <div class="mt-3 flex justify-end">
                            <a href="/piala_walikotasby2026?draft_id={{ $reg->id }}"
                                class="text-xs font-bold text-blue-600 hover:text-blue-800 bg-blue-50 hover:bg-blue-100 px-3 py-1 rounded-full transition-all">
