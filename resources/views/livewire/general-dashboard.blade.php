<div class="space-y-10">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
            ...
            <p class="text-slate-900 font-medium">Selamat datang di Smart-Perkemi, {{ auth()->user()->name }}</p>
        </div>
        <div class="bg-white rounded-2xl px-6 py-3 shadow-sm border border-slate-100 flex items-center gap-3">
            <span class="w-3 h-3 bg-emerald-500 rounded-full animate-pulse"></span>
            <span class="font-bold text-black uppercase text-[15px] tracking-widest">Sesi Aktif</span>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div class="bg-white rounded-[2.5rem] p-10 shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-xl transition-all">
            ...
            <p class="text-slate-900 text-[15px] mb-8 relative z-10">Lihat dan unduh sertifikat prestasi digital Anda.</p>
            <button class="w-full bg-slate-50 hover:bg-orange-600 hover:text-white py-4 rounded-2xl font-bold text-slate-900 transition-all active:scale-95">Lihat Semua</button>
        </div>
        ...
        <div class="bg-white rounded-[2.5rem] p-10 shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-xl transition-all">
            ...
            <p class="text-slate-900 text-[15px] mb-8 relative z-10">Pantau jadwal kejuaraan dan gashuku Nasional.</p>
            <button class="w-full bg-slate-50 hover:bg-blue-600 hover:text-white py-4 rounded-2xl font-bold text-slate-900 transition-all active:scale-95">Buka Kalender</button>
        </div>
        ...
        <div class="bg-white rounded-[2.5rem] p-10 shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-xl transition-all">
            ...
            <p class="text-slate-900 text-[15px] mb-8 relative z-10">Lihat kartu tanda anggota digital PERKEMI Anda.</p>
            <button class="w-full bg-slate-50 hover:bg-emerald-600 hover:text-white py-4 rounded-2xl font-bold text-slate-900 transition-all active:scale-95">Lihat Kartu</button>
        </div>
    </div>
