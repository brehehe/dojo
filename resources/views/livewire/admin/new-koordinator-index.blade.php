<div>
    ...
    <div class="prem-page-a">
        <div class="page-hdr-a">
            <div>
                <h2>Data Koordinator Lapangan</h2>
                <p>Kelola data koordinator lapangan untuk penugasan court</p>
            </div>
        ...
        <div class="stats-grid-a">
            <div class="stat-card-a gold">
                <div class="st-icon gold"><i class="fa-solid fa-user-shield"></i></div>
                <div class="st-val">{{ $users->total() }}</div>
                <div class="st-lbl">Total Koordinator</div>
            </div>
        </div>

        <div class="table-section-prem">
            <div class="table-toolbar-prem">
                <h3>Daftar Koordinator Lapangan</h3>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="3" style="text-align:center;padding:40px 20px;">
                                ...
                                <div style="font-size:12px;color:var(--smoke);">Belum ada data koordinator lapangan.</div>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
        ...
        @if($showingModal)
        <x-modal wire:model.live="showingModal" maxWidth="md">
            <div style="padding:24px;">
                <div class="modal-hdr">
                    <div class="modal-title">{{ $userIdBeingEdited ? 'Edit Koordinator' : 'Tambah Koordinator' }}</div>
                </div>
                <form wire:submit="saveUser">
                    <div class="modal-field">
                        <label>Nama Lengkap *</label>
                        <input wire:model="name" type="text" class="modal-input" placeholder="Nama koordinator lapangan">
                    ...
                    <div class="modal-actions">
                        <button type="button" wire:click="$set('showingModal', false)" class="btn-cancel">Batal</button>
