<div class="space-y-4 animate-in fade-in duration-700">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div class="space-y-1">
            ...
            <div class="flex items-center gap-2">
                ...
                <p class="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Master Data Teknik & Jurus</p>
            </div>
        </div>
        <div class="w-full md:w-auto">
            <button wire:click="showCreateModal"
                ...
                <span class="uppercase text-[9px] tracking-[0.2em]">Tambah Teknik & Jurus</span>
            </button>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div
            ...
            <span class="text-[9px] font-black uppercase tracking-[0.2em] text-white/70 mb-0.5 relative z-10">Total Teknik & Jurus</span>
            ...
            <table class="w-full text-left border-collapse min-w-[400px]">
                <thead>
                    <tr class="bg-slate-50/50">
                        <th class="py-2 px-4 text-slate-400 text-[9px] font-black uppercase tracking-[0.2em] border-b border-slate-100">Nama Teknik & Jurus</th>
                ...
                <tbody class="text-slate-700 font-medium divide-y divide-slate-50">
                    @forelse($techniques as $technique)
                        <tr class="group hover:bg-slate-50/80 transition-all duration-300">
                            <td class="py-2 px-4">
                                <span class="font-bold text-slate-800 group-hover:text-orange-600 transition-colors text-[13px]">{{ $technique->name }}</span>
                            </td>
        ...
        <x-modal wire:model.live="showingTechniqueModal" title="{{ $techniqueIdBeingEdited ? 'Update Teknik & Jurus' : 'Teknik & Jurus Baru' }}">
            <form wire:submit="saveTechnique" class="space-y-6">
                <div class="space-y-1.5">
                    <label class="text-[9px] font-black uppercase tracking-widest text-slate-400 ml-1">Nama Teknik & Jurus</label>
