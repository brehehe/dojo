    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div class="space-y-1">
            ...
            <div class="flex items-center gap-2">
                ...
                <p class="text-[11px] text-slate-500 font-bold uppercase tracking-wider italic">Database Manajer &
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div
            ...
            <div class="flex items-center gap-2 w-full md:w-auto">
                ...
                <div class="flex items-center gap-3 bg-slate-50 px-4 py-2 rounded-lg min-w-fit w-full">
                    <span
                        class="text-[9px] font-black uppercase tracking-widest text-slate-400 whitespace-nowrap">Kontingen:</span>
                    <select wire:model.live="filterContingent"
                        class="bg-transparent border-0 text-slate-700 text-xs font-black focus:ring-0 cursor-pointer p-0 max-w-[150px] truncate">
            ...
            <table class="w-full text-left border-collapse min-w-[800px]">
                <thead>
                    <tr class="bg-slate-50/50">
                        <th
                            class="py-4 px-6 text-slate-400 text-[9px] font-black uppercase tracking-[0.2em] border-b border-slate-100">
                            Nama Official</th>
                        <th
                            class="py-4 px-6 text-slate-400 text-[9px] font-black uppercase tracking-[0.2em] border-b border-slate-100">
                            Kontak</th>
                        <th
                            class="py-4 px-6 text-slate-400 text-[9px] font-black uppercase tracking-[0.2em] border-b border-slate-100 text-center">
                            Peran</th>
                        <th
                            class="py-4 px-6 text-slate-400 text-[9px] font-black uppercase tracking-[0.2em] border-b border-slate-100 text-right">
                            Aksi</th>
                    </tr>
                </thead>
                        ...
                        <tr class="group hover:bg-slate-50/50 transition-colors duration-300">
                            <td class="py-4 px-6">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center text-slate-400 font-black shadow-sm group-hover:scale-110 transition-transform">
                                        <i class="fas fa-user-tie"></i>
                                    </div>
                                    <div class="flex flex-col gap-0.5">
                                        <span
                                            class="font-bold text-slate-800 text-sm tracking-tight group-hover:text-orange-600 transition-colors">{{ $official->name }}</span>
                                        <span class="text-[10px] text-slate-400 font-semibold italic">ID:
                                            {{ $official->id }}</span>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="py-4 px-6 text-center">
                                <span
                                    class="px-2 py-0.5 rounded-md bg-orange-50 text-orange-600 text-[8px] font-black tracking-widest uppercase border border-orange-100">
                                    {{ $official->role ?? 'Official' }}
                                </span>
                            </td>
                            <td class="py-4 px-6 text-right">
                                <div
                                    class="flex items-center justify-end gap-1.5 opacity-0 group-hover:opacity-100 transition-all translate-x-4 group-hover:translate-x-0">
                        ...
                        <tr>
                            <td colspan="5" class="py-24 text-center">
                                <div class="flex flex-col items-center gap-4">
                                    ...
                                    <p class="font-black text-slate-400 uppercase tracking-widest text-[10px]">Data Official
                                        Kosong</p>
                                </div>
                            </td>
                        </tr>
