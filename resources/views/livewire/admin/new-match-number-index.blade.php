    ...
    <div class="prem-page-a">
        ...
        <div class="stats-grid-a">
            ...
            <div class="stat-card-a blue">
                ...
                <div class="st-val">{{ \App\Models\MatchNumber\MatchNumber::where('draft_type', 'embu')->count() }}
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div style="display:flex; gap:6px; margin-top:4px;">
                                        <span
                                            class="badge {{ $mn->draft_type == 'randori' ? 'badge-randori' : 'badge-embu' }}">
                                            {{ $mn->draft_type }}
                                        </span>
                                        <span class="badge badge-gender">
                                            @if ($mn->gender == 'Male')
                                                <i class="fa-solid fa-mars" style="color:#3498db;"></i> Putra
                                            @elseif($mn->gender == 'Female')
                                                <i class="fa-solid fa-venus" style="color:#e74c3c;"></i> Putri
                                            @else
                                                <i class="fa-solid fa-venus-mars" style="color:#9b59b6;"></i> Campuran
                                            @endif
                                        </span>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div style="font-size:12px; font-weight:600; color:var(--ink);">
                                        {{ $mn->max_athletes }} Atlet/Regu</div>
                                </td>
                                <td>
                                    <div style="display:flex;gap:5px;justify-content:flex-end;">
                                        <button wire:click="showAthletes({{ $mn->id }})" class="act-btn-a view"
                                            title="Lihat Atlet">
                                            <i class="fa-solid fa-users"></i>
                                        </button>
                                        <button wire:click="showEditModal({{ $mn->id }})" class="act-btn-a edit"
                                            title="Edit">
                                            <i class="fa-solid fa-pen"></i>
                                        </button>
                                        <button
                                            onclick="confirmDelete({{ $mn->id }}, '{{ addslashes($mn->name) }}')"
                ...
                <div style="padding:24px;">
                    <div class="modal-hdr">
                        <div class="modal-title">
                            {{ $matchNumberIdBeingEdited ? 'Edit Nomor Pertandingan' : 'Tambah Nomor Pertandingan' }}
                        </div>
                    </div>
                    <form wire:submit="saveMatchNumber">
                        <div class="modal-field">
                            ...
                            <input wire:model="name" type="text" class="modal-input"
                                placeholder="Contoh: Randori Dewasa Putra Kelas 60 Kg">
                            @error('name')
                        ...
                        <div class="grid-2">
                            ...
                            <div class="modal-field">
                                ...
                                <input wire:model="max_athletes" type="number" class="modal-input"
                        ...
                        <div class="modal-actions">
                            ...
                            <button type="submit" class="btn-save">
                                ...
                                <span wire:loading wire:target="saveMatchNumber"><i
                            ...
                            @foreach ($registeredAthletes as $ath)
                                <li class="ath-item">
                                    ...
                                    <div class="ath-item-meta">
                                        <span><i class="fa-solid fa-flag text-red-500"></i>
                                            {{ $ath->contingent_name }}</span>
                                        <span>•</span>
                                        <span>{{ $ath->kyu }}</span>
                                        @if ($ath->weight)
                                            <span>•</span>
