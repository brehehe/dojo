 <div class="space-y-10">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div class="flex gap-3">
             <select wire:model.live="statusFilter" class="bg-white border-2 border-slate-100 rounded-2xl px-6 py-3 text-sm font-bold text-slate-700 focus:border-orange-500 outline-none transition-all">
    ...
    <div class="relative group">
        ...
        <input type="text" 
               ...
               placeholder="Cari nama kontingen atau penanggung jawab..." 
    ...
    <div class="bg-white rounded-[2.5rem] p-8 shadow-sm border border-slate-100 overflow-hidden">
        <div class="overflow-x-auto -mx-8">
            <table class="w-full text-left">
                <thead>
                    <tr class="text-slate-400 text-[10px] font-black uppercase tracking-[0.2em] border-b border-slate-100 leading-none">
                    ...
                    <tr class="hover:bg-slate-50/80 transition-colors">
                        ...
                        <td class="py-6 px-8">
                            <div class="flex flex-col min-w-[200px]">
                                <span class="text-slate-800 font-extrabold tracking-tight">{{ $contingent->name }}</span>
                                <span class="text-[10px] text-slate-400 font-bold uppercase tracking-widest">{{ $contingent->kab_kota }}</span>
                            </div>
                        </td>
                        <td class="py-6 px-8">
                        ...
                        <td class="py-6 px-8 text-right">
                             <a href="{{ route('admin.contingents.detail', $contingent) }}" 
