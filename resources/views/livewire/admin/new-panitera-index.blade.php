<div>
    ...
    <div class="prem-page-a">
        <div class="page-hdr-a">
            <div>
                <h2>Data Panitera</h2>
                <p>Kelola data panitera untuk penugasan meja pertandingan</p>
            </div>
            <button wire:click="showCreateModal" class="btn-prem-add">
                <i class="fa-solid fa-user-plus"></i> Tambah Panitera
            </button>
        </div>

        <div class="stats-grid-a">
            <div class="stat-card-a gold">
                <div class="st-icon gold"><i class="fa-solid fa-users-rectangle"></i></div>
                <div class="st-val">{{ $users->total() }}</div>
                <div class="st-lbl">Total Panitera</div>
            </div>
        </div>

        <div class="table-section-prem">
            <div class="table-toolbar-prem">
                <h3>Daftar Panitera</h3>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="3" style="text-align:center;padding:40px 20px;">
                                ...
                                <div style="font-size:12px;color:var(--smoke);">Belum ada data panitera.</div>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
        ...
        <x-modal wire:model.live="showingModal" maxWidth="md">
            <div style="padding:24px;">
                <div class="modal-hdr">
                    <div class="modal-title">{{ $userIdBeingEdited ? 'Edit Panitera' : 'Tambah Panitera' }}</div>
                </div>
                <form wire:submit="saveUser">
                    <div class="modal-field">
                        <label>Nama Lengkap *</label>
                        <input wire:model="name" type="text" class="modal-input" placeholder="Nama panitera">
