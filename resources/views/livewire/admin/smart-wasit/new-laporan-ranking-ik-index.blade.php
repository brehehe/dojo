<div>
    ...
    <div class="tm-page">
        <div class="tm-hdr">
            <div>
                <h2><i class="fas fa-sync" style="color:#27ae60; margin-right:8px;"></i>Ranking Konsistensi (IK)</h2>
                <p>Kestabilan Penilaian Wasit dalam Berbagai Partai Pertandingan (Index of Consistency)</p>
            </div>
        ...
        <div class="tm-info-card">
            <h4>Metode Perhitungan IK</h4>
            <p>IK mengukur kestabilan penilaian seorang wasit. Semakin rendah variasi (Standard Deviation) penilaiannya terhadap rata-rata pribadinya, maka wasit tersebut dianggap semakin konsisten. Nilai IK maksimal adalah 1.000.</p>
            <div class="tm-info-formula">IK = 1 - (Standard Deviation / Mean)</div>
        </div>
            ...
            <table class="tm-table">
                <thead>
                    <tr>
                        ...
                        <th style="text-align:center">Std Deviasi</th>
                ...
                <tbody>
                    ...
                    @foreach($refereeAnalysis->sortByDesc('ik') as $rf)
                        <tr>
                            ...
                            <td align="center" style="color:#27ae60; font-weight:900; font-size:15px">{{ number_format($rf['ik'], 3) }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
