    ...
    <div class="max-w-full mx-auto">
        ...
        <div class="flex items-center justify-between mb-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-[15px] font-black text-slate-800 uppercase tracking-tight">Wasit Juri</h2>
                    <p class="text-[15px] font-bold text-slate-800 uppercase tracking-widest">
            ...
            <div
                ...
                <div class="p-4 md:p-8">
                    @if($activeMatch->draft_type === 'embu')
                        ...
                        <!-- Common Footer Actions for Embu -->
                    ...
                    @else
                        ...
                        <div class="py-10 text-center">
                            ...
                            <h3 class="text-lg font-black text-slate-800 uppercase tracking-tight">Kategori Randori Aktif</h3>
                            <p class="text-[15px] text-slate-900 font-medium mt-2 max-w-[400px] mx-auto leading-relaxed">
                                Penilaian kategori Randori dilakukan langsung oleh **Panitera** di meja pertandingan.
                                Anda tidak perlu memasukkan skor melalui panel ini.
                            </p>
                        </div>
                    @endif
                </div>
        ...
        @else
            ...
            <div class="bg-white rounded-[2.5rem] p-12 text-center border-2 border-dashed border-slate-200 animate-pulse">
                ...
                <p class="text-[15px] text-slate-900 font-medium mt-2 max-w-[200px] mx-auto leading-relaxed">
        ...
        <div class="mt-8 flex justify-center opacity-50">
            <span class="flex items-center gap-2 text-[15px] font-black uppercase tracking-widest text-slate-800">
