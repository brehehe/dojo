...
<header class="sticky top-0 z-[100]" x-data="{ mobileMenuOpen: false }">
    ...
    <div
        class="bg-gradient-to-r from-orange-700 via-orange-600 to-orange-500 text-white shadow-lg border-b border-white/10 relative">
                ...
                <div class=z"flex items-center gap-4">
                    <div
                        ...
                        <img src="{{ asset('logo.jpeg') }}" alt="Logo"
                            class="w-7 h-7 md:w-9 md:h-9 rounded-lg object-cover">
                    </div>
                ...
                <div class="flex items-center gap-2 md:gap-6">
                    ...
                    <div class="relative" x-data="{ userDropdownOpen: false }" @click.away="userDropdownOpen = false">
                        <button @click="userDropdownOpen = !userDropdownOpen"
                            ...
                            <div class="relative">
                                <div
                                    class="w-9 h-9 md:w-11 md:h-11 bg-white/20 backdrop-blur-md border border-white/20 rounded-xl flex items-center justify-center text-white font-black shadow-lg group-hover:scale-105 transition-transform overflow-hidden">
                                    {{ auth()->user()->initials() }}
                                </div>
                                <div
                        ...
                        <div x-show="userDropdownOpen" x-transition:enter="transition ease-out duration-100"
                            ...
                            <div class="px-6 py-4 mb-2 bg-slate-50 border-b border-slate-100 flex items-center gap-4">
                                <div
                                    class="w-12 h-12 bg-orange-600 rounded-2xl flex items-center justify-center text-white font-black shadow-lg">
                                    {{ auth()->user()->initials() }}
                                </div>
                    ...
                    <button @click="mobileMenuOpen = !mobileMenuOpen"
                        class="md:hidden w-10 h-10 flex items-center justify-center bg-white/10 rounded-xl text-white">
        ...
        <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
            <nav class="flex items-center gap-2 h-14">
                ...
                <div class="relative h-full" x-data="{ reportDropdownOpen: false }"
                    ...
                    <div x-show="reportDropdownOpen" x-transition:enter="transition ease-out duration-200"
    ...
    <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="mt-auto pt-8 border-t border-white/5">
            <div class="flex items-center gap-4 p-6 bg-white/5 rounded-[2.5rem] mb-6 shadow-inner">
                <div
                    class="w-14 h-14 bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl flex items-center justify-center text-white font-black text-xl shadow-lg">
                    {{ auth()->user()->initials() }}
                </div>
