...
class AdminMasterContingentDetailIndex extends Component
{
    public $contingent;
    ...
    public function createNewRegistration()
    {
        ...
        $this->dispatch('swal', title: 'Berhasil!', text: 'Batch pendaftaran baru berhasil dibuat.', icon: 'success');
    }

    public function render()
    {
        return view('livewire.admin.master.contingent.admin-master-contingent-detail-index');
    }
}
