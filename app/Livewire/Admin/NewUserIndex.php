...
class NewUserIndex extends Component
{
    ...
    public function render()
    {
        ...
        $users = $query->latest()->paginate($this->perPage === 'all' ? User::count() : $this->perPage);
        $roles = Role::all();

        return view('livewire.admin.new-user-index', [
            'users' => $users,
            'roles' => $roles,
        ])->layout('layouts.premium', ['title' => 'Manajemen Pengguna']);
    }
}
