...
class AdminLaporanRankingSkwIndex extends Component
{
    ...
    public function render()
    {
        ...
        $refereeAnalysis = $this->getRefereeAnalysis()->sortByDesc('skw');

        return view('livewire.admin.smart-wasit.admin-laporan-ranking-skw-index', [
            'ageGroups' => $ageGroups,
            'referees' => $referees,
    ...
    public function exportExcel()
    {
        ...
        return Excel::download(
            new RefereeAnalysisExport($data, 'SKW'),
            'Ranking_SKW_'.now()->format('Ymd_His').'.xlsx'
        );
    }
}
