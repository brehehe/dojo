...
class AdminLaporanRankingIkIndex extends Component
{
    ...
    public function render()
    {
        ...
        $refereeAnalysis = $this->getRefereeAnalysis()->sortByDesc('ik');

        return view('livewire.admin.smart-wasit.admin-laporan-ranking-ik-index', [
            'ageGroups' => $ageGroups,
            'referees' => $referees,
    ...
    public function exportExcel()
    {
        ...
        return Excel::download(
            new RefereeAnalysisExport($data, 'IK'),
            'Ranking_IK_'.now()->format('Ymd_His').'.xlsx'
        );
    }
}
